...
const Banner = () => {
    ...
    return (
        <Swiper
            ...
            className='w-3/4 mx-auto lg:my-10 my-5'
        >
            <SwiperSlide>
                <div className="hero h-[500px]" style={{ backgroundImage: 'url(https://i.ibb.co/F6SRmfr/image20.jpg)' }}>
            ...
            <SwiperSlide>
                <div className="hero h-[500px]" style={{ backgroundImage: 'url(https://i.ibb.co/ZfgGcT7/image25.jpg)' }}>
                    <div data-aos="fade-right"
                        data-aos-offset="300"
                        data-aos-easing="ease-in-sine" className="hero-content justify-start z-50 text-neutral-content bg-opacity-20  hero-overlay">
                        <div data-aos="fade-right"
                            data-aos-offset="300"
